...
<h1 style="text-align:center; font-size:25px;font-family: Calibri, Helvetica, sans-serif;"></h10>
...
<!--Add Button-->
<a href="bookmovie.php" style =" text-align:center; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Book Movie</button>
  </a>
  



<!--SearchBooking Button-->
<a href="participantsmovie.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
...
<div class="article-container">
    <?php
	   ...
	   if($queryResults >0){
       error_reporting(0);
       echo "<table style='text-align:center;border-collapse: collapse;margin: 20px 0; font-size: 20px;min-width: 400px;border-radius: 5px 5px 0 0;overflow: hidden;box-shadow: 0 0 20px rgba(0, 0, 0, 0.15);'>
