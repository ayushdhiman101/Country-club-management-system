...
<!--Add Button-->
<a href="bookcompetition.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Take Part</button>
  </a>
...
List of participants in various competitions
</h1>

<div class="article-container">
    <?php
	   $sql="SELECT * FROM competitionbooking";
    ...
    echo "
     ...
     <tr style='color:white ;background-color: #5D6D7E ;text-align: left;font-weight: bold;padding: 12px 15px;'>
	             <th style='padding: 12px 15px;'>Competition ID</th>
                <th style='padding: 12px 15px;'>Member ID</th>
                <th style='padding: 12px 15px;'>Team Name</th>
                <th style='padding: 12px 15px;'>Team strength </th>
				</tr>";
	   while($row = mysqli_fetch_assoc($result)){
		...
		echo"<div>
                ...
                <td style='padding: 12px 15px;'><p>".$row['memberIDD']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['teamname']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['numberofpeopleinteam']."</p></td>
