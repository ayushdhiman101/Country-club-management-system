...
<a href="bookcompetition.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Participate</button>
  </a>
  


<!--SearchBooking Button-->
<a href="participantscompetition.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Participants</button>
  </a>
