...
<form action="bookcompetition.php" method="post">
A full team of that particular sport with 2 subsitutes are compulsary.
<br><br>
     <input type="number" name="CID" placeholder="Competition I.D">
	 <br><br>
	 <input type="number" name="MID" placeholder="Member ID">
	 <br><br>
	 <input type="text" name="TN" placeholder="Team Name">
	 <br><br>
	 <input type="number" name="NOP" placeholder="No of Participants">
	 <br><br>
	 <button style='color:red;'type="submit" name="submit">TAKE PART</button>
</form>	 
</h1>
...
$compiID2=$_POST['CID'];
$sql="INSERT INTO cards (memberID,MonthBill,Reason) VALUES ('$compiDate1','1000','Competition Booking ID-$compiID2');";
...
<?php 
  ...
  $compiID=$_POST['CID'];
	...
	$compiTime=$_POST['TN'];
	$sportttID=$_POST['NOP'];
  $sql="INSERT INTO competitionbooking (competitionID,memberIDD,teamname,numberofpeopleinteam) VALUES ('$compiID','$compiDate','$compiTime','$sportttID');";
