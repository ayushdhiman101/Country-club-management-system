...
<br><br>
     <input type="number" name="CID" placeholder="Movie I.D">
	 <br><br>
	 <input type="number" name="MID" placeholder="Member I.D">
	 <br><br>
...
$sql="INSERT INTO cards (memberID,MonthBill,Reason) VALUES ('$compiDate1','$Sum','Movie Booking , ID - $compiID2');";
...
<?php 
  ...
  $sql="INSERT INTO moviebooking (movienumber,memberID,numberofseatsbooked) VALUES ('$compiID','$compiDate','$compiTime');";
