...
<?php 
	...
	$Functionnam=$_POST['F'];
    $sql="INSERT INTO partyhalluser(memberID,Dateoffunction,timeoffunction,Endtimeoffunction,Functionname) VALUES( '$MMIDD','$Dateoffunctio','$timeoffunctio','$Endtimeoffunctio','$Functionnam');";
