...
<form action="addevents.php" method="POST">
	 ...
	 <br><br>
	 <input type="number" name="eticket" placeholder="Cost of ticket">
	 <br><br>
	 <input type="date" name="edate" placeholder="Event Date">
	 <br><br>
	 <input type="time"  name="etime" placeholder="Event Time">
	 <br><br>
...
$conn =mysqli_connect($server,$username,$password,$dbname);
    ...
    $ventname=$_POST['ename'];
	$ostofeachticket=$_POST['eticket'];
	$ventdate=$_POST['edate'];
	$venttime=$_POST['etime'];
  $sql="INSERT INTO eventss (eventname,costofeachticket,eventdate,eventtime) VALUES('$ventname','$ostofeachticket','$ventdate','$venttime');";
