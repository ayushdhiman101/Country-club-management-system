...
<?php
   ...
   if(isset($_POST['submit-search'])){
	   ...
	   $sql="SELECT * FROM member WHERE MemberName LIKE '%$search%' OR MemberID LIKE '%$search%'" ;
...
error_reporting(0);
     ...
     <tr style='color:white ;background-color: #5D6D7E ;text-align: left;font-weight: bold;padding: 12px 15px;'>
                ...
                <th style='padding: 12px 15px;'SportsID</th>
                <th style='padding: 12px 15px;'>Member Image</th>
				</tr>";
	     ...
	     while($row =mysqli_fetch_assoc($result)){
                ...
                <td style='padding: 12px 15px;'><p>".$row['Image']."</p></td>
