...
<?php
   ...
   if(isset($_POST['submit-search'])){
	   ...
	   $sql="SELECT * FROM competitions WHERE competitionID LIKE '%$search%' OR competitionName LIKE '%$search%' OR competitiondate LIKE '%$search%' OR competitiontime LIKE '%$search%' ";
