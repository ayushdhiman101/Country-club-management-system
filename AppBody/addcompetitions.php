...
<form action="addcompetitions.php" method="POST">
     <input type="text" name="ID" placeholder="Competition I.D">
	 <br><br>
	 <input type="text" name="Name" placeholder="Competition Name">
	 <br><br>
	 <input type="date" name="date" placeholder="Competition Date">
	 <br><br>
	 <input type="time" name="t" placeholder="Competition Time">
	 <br><br>
	 <input type="text" name="ID2" placeholder="Sports I.D">
	 <br><br>
...
error_reporting(0);
	...
	$compttime=$_POST['t'];
	$sportID=$_POST['ID2'];
    $sql="INSERT INTO competitions (competitionID,competitionName,competitiondate,competitiontime,sportsID) VALUES('$compID','$compName','$compdate','$compttime','$sportID');";
