...
<form action="competitiondelete.php">
<input type="text" name="ageed" id="age" placeholder='Competition ID to delete'>
...
$conn =mysqli_connect($server,$username,$password,$dbname);
 ...
 $comp=$_GET['ageed'];
 $sql="DELETE FROM competitions WHERE competitionID  ='$comp'";
