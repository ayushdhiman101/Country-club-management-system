...
<form action="partyhalldelete.php">
<input type="text" name="age4" id="age4" placeholder='Event ID '>
...
$conn =mysqli_connect($server,$username,$password,$dbname);
 $PartHallID=$_GET['age4'];
 $sql="DELETE FROM partyhall WHERE PartHallID ='$PartHallID'";
