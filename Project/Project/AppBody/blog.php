...
<!--Add Button-->
<h1 style="text-align:center; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
<a href="addblog.php" style ="margin:20px; margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Add Blog</button>
  </a>
<a href="blogdelete.php" style =" margin:20px;margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-del" size="100%">Delete Blog</button>
   </a>
...
<!--Delete  Button-->
<h1 style="text-align:center; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
<a href="blogdelete.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
...
<div class="article-container">
    ...
    echo "
     ...
     <tr style='color:white ;background-color: #5D6D7E ;text-align: left;font-weight: bold;padding: 12px 15px;'>
                <th style='padding: 12px 15px;'>Blog ID</th>
                <th style='padding: 12px 15px;'>Remark</th>
                <th style='padding: 12px 15px;'>Author Name</th>
     ...
     ";
	   while($row = mysqli_fetch_assoc($result)){
            echo "<div>			 
                ...
                <td style='padding: 12px 15px;'><p>".$row['blogID']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['remark']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['authorname']."</p></td>
