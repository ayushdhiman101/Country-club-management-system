...
<!--Add Button-->
<h1 style="text-align:center; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
<a href="bookpartyhaall.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Book Hall</button>
  </a>
  </h1>
...
<div class="article-container">
    <?php
     ...
     <tr style='background-color:#34495E;color: white;text-align: left;font-weight: bold;padding: 12px 15px;'>
                ...
                <th style='padding: 12px 15px;'>Function Name</th>
                <th style='padding: 12px 15px;'>Date Of Function</th>
                <th style='padding: 12px 15px;'>Time Of Function</th>
                <th style='padding: 12px 15px;'>End Time of function</th>
				</tr>";
      ...
      echo "<div>
               ...
               <tr  style='font-size: 20px;background-color: #f3f3f3; border-bottom: 10px solid khaki;font-weight: bold;'>
                ...
                <td style='padding: 12px 15px;'><p>".$row['Functionname']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['Dateoffunction']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['timeoffunction']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['Endtimeoffunction']."</p></td>
