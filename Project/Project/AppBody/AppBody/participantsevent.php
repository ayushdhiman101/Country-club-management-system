...
List of participants in various events
</h1>

<div class="article-container">
    <?php
	   $sql="SELECT * FROM eventbooking";
    ...
    echo "
     ...
     <tr style='color:white ;background-color: #5D6D7E ;text-align: left;font-weight: bold;padding: 12px 15px;'>
	             <th style='padding: 12px 15px;'>Eevent ID</th>
                <th style='padding: 12px 15px;'>Member ID</th>
                <th style='padding: 12px 15px;'>No of tickets</th>
	   ...
	   while($row = mysqli_fetch_assoc($result)){
		...
		echo"<div>
                ...
                <td style='padding: 12px 15px;'><p>".$row['eventID']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['memberID']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['numberofmembers']."</p></td>
