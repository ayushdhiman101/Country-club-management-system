...
<!--Add Button-->
<a href="bookmovie.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
     ...
     <tr style='color:white ;background-color: #5D6D7E ;text-align: left;font-weight: bold;padding: 12px 15px;'>
	   ...
	   while($row = mysqli_fetch_assoc($result)){
		...
		echo"<div>
                ...
                <td style='padding: 12px 15px;'><p>".$row['numberofseatsbooked']."</p></td>
