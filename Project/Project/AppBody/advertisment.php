...
<body background="../ResourcesNEW/advertismnetback.jpg" style=" background-position: center;
  background-repeat: no-repeat;
  background-size: cover;">
<h1 style="text-align:center; font-size:25px;font-family: Calibri, Helvetica, sans-serif;" >
<form action="searchadvertisment.php" method="POST">
...
<a href="addadvertisement.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Add Advert</button>
  </a>
  <a href="advertismentdelete.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Delete Advert</button>
  </a>
  </h1>
...
<div class="article-container">
 ...
 echo "
     ...
     <tr style='color:white ;background-color: #5D6D7E ;text-align: left;font-weight: bold;padding: 12px 15px;'>
                <th style='padding: 12px 15px;'>Advertisment ID</th>
                <th style='padding: 12px 15px;'>Cost Of advertisment</th>
                <th style='padding: 12px 15px;'>Type Of Advertisment</th>
                <th style='padding: 12px 15px;'>Outreach Number</th>
                <th style='padding: 12px 15px;'>Admin </th>
	   ...
	   while($row = mysqli_fetch_assoc($result)){
	        echo "<div>
                ...
                <td style='padding: 12px 15px;'><p>".$row['addID']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['cost']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['typeofadvertisement']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['numberofpeopleitsgoingtoreach']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['adminID']."</p></td>
