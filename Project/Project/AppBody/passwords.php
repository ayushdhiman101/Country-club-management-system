...
<body background="../ResourcesNEW/passback.jpg" style=" background-position: center;
...
<div class="article-container">
    <?php
     ...
     <tr style='color:white ;background-color: #5D6D7E ;text-align: left;font-weight: bold;padding: 12px 15px;'>
                ...
                <th style='padding: 12px 15px;'>Password</th>
	   ...
	   while($row = mysqli_fetch_assoc($result)){
	        echo "<div>
                ...
                <td style='padding: 12px 15px;'><p>".$row['ID']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['User']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['Password']."</p></td>
                <td style='padding: 12px 15px;'><p>".$row['role']."</p></td>
