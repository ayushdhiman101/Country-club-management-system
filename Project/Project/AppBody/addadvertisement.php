...
<form action="addadvertisement.php" method="POST">
     ...
     <input type="text" name="addID" placeholder="Add I.D">
	 <br><br>
	 <input type="text" name="cost" placeholder="Cost">
	 <br><br>
	 <input type="text" name="typeofadvertisement" placeholder="Type of advert">
	 <br><br>
	 <input type="text" name="adminID" placeholder="Admin I.D">
	 <br><br>
	 <input type="text" name="numberofpeopleitsgoingtoreach" placeholder="Advert Reach">
	 <br><br>
...
error_reporting(0);
    ...
    $addID=$_POST['addID'];
	$cost=$_POST['cost'];
	$typeofadvertisement=$_POST['typeofadvertisement'];
	$adminID=$_POST['adminID'];
	$numberofpeopleitsgoingtoreach=$_POST['numberofpeopleitsgoingtoreach'];
    $sql="INSERT INTO advertisement (addID,cost,typeofadvertisement,adminID,numberofpeopleitsgoingtoreach) VALUES('$addID','$cost','$typeofadvertisement','$adminID','$numberofpeopleitsgoingtoreach');";
