...
<a href="monthbilldelete.php" style =" margin-top:1px; text-align:right; font-size:25px;font-family: Calibri, Helvetica, sans-serif;">
  <button type="submit" name="submit-add" size="100%">Delete</button>
  </a>
</h1>
...
<?php
   ...
   if(isset($_POST['submit-search'])){
	   ...
	   $sql="SELECT * FROM cards WHERE memberID LIKE '%$search%'";
     ...
     <tr style='color:white ;background-color: #5D6D7E ;text-align: left;font-weight: bold;padding: 12px 15px;'>
                ...
                <th style='padding: 12px 15px;'>MemberID</th>
                <th style='padding: 12px 15px;'>Month Bill</th>
