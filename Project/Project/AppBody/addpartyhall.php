...
<form action="addpartyhall.php" method="POST">
  
	 <input type="text" name="D" placeholder="Location">
	 <br>
	 <input type="text" name="t" placeholder="Max Occupancy">
	 <br>
	 <input type="date" name= "E" placeholder="Date of inaguration">
	 <br>
	 <input type="text" name="F" placeholder="Inaugrated by">
	 <br>
...
<?php 
	...
	$Functionnam=$_POST['F'];
    $sql="INSERT INTO partyhall(Location,Maxoccupancy,Dateofinaguration,Inaugratedby) VALUES('$Dateoffunctio','$timeoffunctio','$Endtimeoffunctio','$Functionnam');";
